    <section class="promo">
        ...
        <ul class="promo__list">
            ...
            <li class="promo__item promo__item--<?= htmlspecialchars($categories_list['code']); ?>">
                <a class="promo__link" href="all-lots.php?category_id=<?= htmlspecialchars($categories_list['id']); ?>">
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=htmlspecialchars($lots_val['path']);?>" width="350" height="260"
                        alt="<?=htmlspecialchars($lots_val['title']);?>">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=htmlspecialchars($lots_val['category']);?></span>
                    <h3 class="lot__title">
                        <a class="text-link" href="lot.php?id=<?= htmlspecialchars($lots_val['id']); ?>">
                        <?=htmlspecialchars($lots_val['title']);?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?=format_price(htmlspecialchars($lots_val['price']));?></span>
                        </div>
                        <?php $warningDate = get_time_left(htmlspecialchars($lots_val['expiration']));?>
