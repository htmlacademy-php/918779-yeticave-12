    <nav class="nav">
      ...
      <?php foreach ($categories as $categories_val): ?>
        <li class="nav__item">
          <a href="all-lots.html"><?= $categories_val['title']; ?></a>
        </li>
      <?php endforeach; ?>
      </ul>
    </nav>
    ...
    <form class="form form--add-lot container <?= $classname; ?>" action="add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
      ...
      <div class="form__container-two">
        ...
        <div class="form__item <?= $classname; ?>">
          ...
          <select id="category" name="category_id">
            ...
            <?php foreach ($categories as $categories_val): ?>
            <option value="<?= $categories_val["id"]; ?>"><?= $categories_val['title']; ?></option>
            <?php endforeach; ?>
          </select>
      ...
      <?php $classname = isset($errors["price"]) ? "form__item--invalid" : ""; ?>
        ...
        <div class="form__item <?= $classname; ?>">
          ...
          <input class="form__input-date" id="lot-date" type="text" name="expiration" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
