...
INSERT INTO bets (cost, user_id, lot_id, date_bet)
...
SELECT lots.title, lots.price, lots.path, categories.title, MAX(bets.cost) as current_price
FROM lots
...
SELECT bets.date_bet, bets.cost, lots.title, users.name
FROM bets
