    ...
    <section class="promo">
        ...
        <ul class="promo__list">
            ...
            <li class="promo__item promo__item--boards">
                <a class="promo__link" href="pages/all-lots.html"><?= $category_title;?></a>
            </li>
            <?php endforeach; ?>
        </ul>
    </section>
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$lots_val['path']; ?>" width="350" height="260" alt="">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$lots_val['category']; ?></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$lots_val['title']; ?></a></h3>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            ...
            <?php foreach ($categories as $category_title):?>
            <li class="nav__item">
                <a href="pages/all-lots.html"><?= $category_title;?></a>
            </li>
            <?php endforeach; ?>
        </ul>
    </nav>
